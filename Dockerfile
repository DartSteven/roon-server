...
RUN wget https://github.com/BtbN/FFmpeg-Builds/releases/download/latest/ffmpeg-n8.0-latest-linux64-gpl-8.0.tar.xz \
    && tar -xf ffmpeg-n8.0-latest-linux64-gpl-8.0.tar.xz ffmpeg-n8.0-latest-linux64-gpl-8.0/bin/ffmpeg \
    && mv ffmpeg-n8.0-latest-linux64-gpl-8.0/bin/ffmpeg /usr/local/bin/ffmpeg \
